...
const PROTECTED = ['/dashboard', '/dispatch', '/loads', '/trips', '/fuel', '/expenses', '/audit', '/delays', '/mis', '/settings', '/trip']
    ...
    cookies: {
      ...
      setAll(toSet) {
        ...
        toSet.forEach(({ name, value, options }) =>
          supabaseResponse.cookies.set(name, value, { ...COOKIE_OPTS, ...options } as Parameters<typeof supabaseResponse.cookies.set>[2])
        )
      },
    },
  })
